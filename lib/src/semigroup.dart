...
/// - This method has to be associative, i. e.
///     - `append(append(a, b), c) == append(a, append(b, c))`.
///
/// For example, a [Semigroup] on [int] with the operation `+` would be like:
/// ```dart
...
abstract class Semigroup<A> {
  ...
  /// Combines two elements into one (curried).
